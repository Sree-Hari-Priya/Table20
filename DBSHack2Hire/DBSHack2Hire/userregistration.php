...
<div class="main" align="center">
    ...
    <form name="customerreg" class="form1" align="center" action="userregistration.php" method="POST">
    <input class="mail" type="text" placeholder="Your Name" name="name" autofocus required>
	 <input class="mail" type="text" placeholder="Username" name="uname" autofocus required>
